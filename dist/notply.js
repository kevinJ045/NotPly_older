...
function NotPlyInitiate(AppLication){
...
function NotifyAsAll(NotPlymessage,NotPlytheme,NotPlyicon,NotPlyplaceholder,NotPlybutton,NotPlylabel,NotPlybtfun,NotPlybtclass,NotPlyinputid,NotPlyinputclass,NotPlytransition){
...
function NotifyAsButton(NotPlymessage,NotPlytheme,NotPlyicon,NotPlybutton,NotPlybtfun,NotPlybtclass,NotPlytransition){
...
function NotifyAs(NotPlymessage,NotPlytheme,NotPlyicon,NotPlytransition){
...
function muSet(){
 ...
 function alertAs(text,title,theme){
 ...
 function alertAsConfirm(text,title,sbutton,onsubmit,oncancel,theme){
 	$("#activeNotAlert").remove();
 	$(LolyCont).addClass("overflowHidden");
 	if(title){
 		 var title = title;
...
function alertAsPrompt(text,title,sbutton,onsubmit,oncancel,theme){
	$("#activeNotAlert").remove();
	$(LolyCont).addClass("overflowHidden");
 	if(title){
 		 var title = title;
...
function alertAsLoading(text,delay,Mfunction,theme){
	$("#activeNotAlert").remove();
	$(LolyCont).addClass("overflowHidden");
